...
<FORM Name="AddProj" ACTION="AddProject.jsp" onsubmit="return validate()">
	...
	<TR class=row_odd>
		...
		<font color="#224426"><a onClick="javascript:showCalendar(this, AddProj.DealDate, 'yyyy-mm-dd',0,400,300)" href="#"><img alt="Calendar" border="0" height="18" src="Images/calendar.gif" width="18"></a></font>
	</TR>

	<TR>
		<TD>Start Date <FONT COLOR="red">*</FONT></TD>
		<TD><Input type="text" name='StartDate' value='' readonly>
		<font color="#224426"><a onClick="javascript:showCalendar(this, AddProj.StartDate, 'yyyy-mm-dd',0,400,300)" href="#"><img alt="Calendar" border="0" height="18" src="Images/calendar.gif" width="18"></a></font>
	</TR>
	<TR class=row_odd>
