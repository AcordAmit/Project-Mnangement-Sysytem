...
oCMenu.offlineUrl="file:///C:\Program Files\Apache Software Foundation\Tomcat 6.0\webapps\MCFPO" //Value: "path_to_menu_file_offline/"
...
oCMenu.barcolor="#996666" //The color of the background bar - Value: "color"
...
//oCMenu.menuplacement=new Array('1','150','301','451','601')
oCMenu.menuplacement=new Array('10%','20%','30%','40%','50%','60%','70%','80%','90%')//,'62.5%','75%','87.5%','99%')
...
oCMenu.level[0].bgcoloroff="#996666" //The default background color for each level[0] (top) items. You can override this on each item by spesifying the backgroundcolor when making the item. - Value: "color"
...
oCMenu.level[1].bgcoloroff="#996666"
...
oCMenu.level[2].bgcoloroff="#996666"
...
oCMenu.makeMenu('top0','','<b>&nbsp;Employees</b>','','')
    oCMenu.makeMenu('sub00','top0','&nbsp;View&nbsp;','ViewEmp.jsp','Frame3')
    oCMenu.makeMenu('sub01','top0','&nbsp;Add&nbsp;','AddEmp.jsp','Frame3')
    oCMenu.makeMenu('sub02','top0','&nbsp;Remove&nbsp;','DelEmp.jsp','Frame3')
oCMenu.makeMenu('top1','','<b>&nbsp;Projects</b>','','')
    oCMenu.makeMenu('sub10','top1','&nbsp;View&nbsp;','ViewProj.jsp','Frame3')
    oCMenu.makeMenu('sub11','top1','&nbsp;Add&nbsp;','AddProj0.jsp','Frame3')
    oCMenu.makeMenu('sub12','top1','&nbsp;Remove&nbsp;','DelProj.jsp','Frame3')
oCMenu.makeMenu('top2','','<b>&nbsp;Requirement</b>','','')//,0,0,"","",'red','silver')
    oCMenu.makeMenu('sub20','top2','&nbsp;View&nbsp;','ViewReq.jsp','')
	oCMenu.makeMenu('sub21','top2','&nbsp;Add&nbsp;','AddReq.jsp','')	
oCMenu.makeMenu('top3','','<b>&nbsp;Allocation</b>','','')//,0,0,"","",'red','silver')
    oCMenu.makeMenu('sub30','top3','&nbsp;View&nbsp;','ViewAlloc.jsp','')
	oCMenu.makeMenu('sub31','top3','&nbsp;Allocate&nbsp;','Allocate0.jsp','')	
oCMenu.makeMenu('top4','','<b>&nbsp;HRD</b>','','')//,0,0,"","",'red','silver')
    oCMenu.makeMenu('sub40','top4','&nbsp;GAP Summary&nbsp;','GapSummary.jsp','')
	oCMenu.makeMenu('sub41','top4','&nbsp;GAP Role wise&nbsp;','RolewiseGapSummary.jsp','')	
oCMenu.makeMenu('top5','','<b>&nbsp;Reports</b>','','')//,0,0,"","",'red','silver')
    oCMenu.makeMenu('sub50','top5','&nbsp;Role-Location','GenericAvsBReport.jsp?TableName=employees&VerCategory=Role&HorCategory=Location&Title=Role-Location Report','Frame3')
    oCMenu.makeMenu('sub51','top5','&nbsp;Project-Location','GenericAvsBReport.jsp?TableName=employees&VerCategory=ProjectCode&HorCategory=Location&Title=Project-Location Report','Frame3')
    oCMenu.makeMenu('sub52','top5','&nbsp;Role-Skill&nbsp;','GenericAvsBReport.jsp?TableName=employees&VerCategory=Skill&HorCategory=Role&Title=Skill-Role Report','Frame3')
    oCMenu.makeMenu('sub53','top5','&nbsp;Project-Skill&nbsp;','GenericAvsBReport.jsp?TableName=employees&VerCategory=ProjectCode&HorCategory=Skill&Title=Project-Skill Report','Frame3')
    oCMenu.makeMenu('sub54','top5','&nbsp;Skill-Location&nbsp;','GenericAvsBReport.jsp?TableName=employees&VerCategory=Skill&HorCategory=Location&Title=Location-Skill Report','Frame3')
oCMenu.makeMenu('top6','','<b>&nbsp;Admin</b>','','')//,0,0,"","",'red','silver')
    oCMenu.makeMenu('sub60','top6','&nbsp;Add User&nbsp;','AddUser.jsp','')
	oCMenu.makeMenu('sub61','top6','&nbsp;Remove User&nbsp;','DeleteUser1.jsp','')
	oCMenu.makeMenu('sub62','top6','&nbsp;Reset Password&nbsp;','ResetPassword1.jsp','')
oCMenu.makeMenu('top7','','<b>&nbsp;Logout</b>','Logout.jsp','Frame3')
