...
<%
	...
	String Role = request.getParameter("Role");	String Location = request.getParameter("Location");	String Skill = request.getParameter("Skill");	String NoEmpOnsite = request.getParameter("NoEmpOnsite");	String NoEmpOffshore = request.getParameter("NoEmpOffshore");	
	int ReqID=1;
	try{
