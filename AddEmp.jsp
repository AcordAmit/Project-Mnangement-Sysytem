...
<FORM Name="AddEmp" id="AddEmp" action="AddEmployee.jsp" onsubmit="return validate()">
	<TABLE align=center>
	<TR class=row_odd>
	...
	<TR>
		...
		<TD><Input type="text" name="JoiningDate" id="JoiningDate" size="15" readonly="readonly">
		 <font color="#224426"><a onClick="javascript:showCalendar(this, AddEmp.JoiningDate, 'yyyy-mm-dd',0,400,300)" href="#"><img alt="Calendar" border="0" height="18" src="Images/calendar.gif" width="18"></a></font>
		</TD>
		</TR>
	<TR class=row_odd>
